...
import theridion_grpc_echo_pb2 as echo__pb2
...
class EchoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Ping = channel.unary_unary(
                ...
                request_serializer=echo__pb2.PingRequest.SerializeToString,
                response_deserializer=echo__pb2.PingReply.FromString,
                _registered_method=True)
...
def add_EchoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Ping': grpc.unary_unary_rpc_method_handler(
                    servicer.Ping,
                    request_deserializer=echo__pb2.PingRequest.FromString,
                    response_serializer=echo__pb2.PingReply.SerializeToString,
            ),
...
class EchoService(object):
    ...
    def Ping(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/echo.EchoService/Ping',
            echo__pb2.PingRequest.SerializeToString,
            echo__pb2.PingReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
