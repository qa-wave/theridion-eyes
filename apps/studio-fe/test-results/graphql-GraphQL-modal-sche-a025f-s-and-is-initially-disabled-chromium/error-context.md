...
- Name: graphql.spec.ts >> GraphQL modal >> schema introspection button exists and is initially disabled
- Location: tests/e2e/graphql.spec.ts:37:3
...
Locator: getByRole('button', { name: 'Schema' })
Expected: visible
Error: strict mode violation: getByRole('button', { name: 'Schema' }) resolved to 2 elements:
    1) <button disabled type="button" class="inline-flex items-center gap-1.5 rounded-md border border-glass px-3 py-1.5 text-xs text-neutral-400 transition hover:bg-white/[0.04] hover:text-neutral-200 disabled:opacity-40">…</button> aka getByRole('button', { name: 'Schema' }).first()
    2) <button type="button" class="relative px-3 py-2 text-xs font-medium transition text-neutral-400 hover:text-neutral-200">Schema</button> aka getByRole('button', { name: 'Schema' }).nth(1)

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByRole('button', { name: 'Schema' })
...
- generic [ref=e1]:
  - generic [ref=e3]:
    ...
    - contentinfo [ref=e249]:
      - button "sidecar v0.0.1 · 57s · 0m" [ref=e251] [cursor=pointer]:
        - generic [ref=e255]: sidecar v0.0.1
        - generic [ref=e256]: · 57s
        - generic [ref=e257]: · 0m
    ...
    - generic [ref=e270]:
      ...
      - generic [ref=e290]:
        - generic [ref=e291]:
          ...
          - generic [ref=e297]: Loading editor…
          - generic [ref=e298]: Variables
          - generic [ref=e303]: Loading editor…
          - generic [ref=e304]: Headers
          - generic [ref=e309]: Loading editor…
        - generic [ref=e310]:
          - generic [ref=e311]:
            - button "Response" [ref=e312] [cursor=pointer]: Response
            - button "Schema" [ref=e314] [cursor=pointer]
          - generic [ref=e316]:
            - img [ref=e317]
