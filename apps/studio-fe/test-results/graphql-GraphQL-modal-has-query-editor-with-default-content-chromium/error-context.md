...
- Name: graphql.spec.ts >> GraphQL modal >> has query editor with default content
- Location: tests/e2e/graphql.spec.ts:25:3
...
Locator: getByText('Headers', { exact: true })
Expected: visible
Error: strict mode violation: getByText('Headers', { exact: true }) resolved to 2 elements:
    1) <button type="button" class="relative h-8 rounded-lg px-3 text-[11px] font-medium transition-all duration-150 text-neutral-500 hover:text-neutral-300 hover:bg-white/[0.03]">Headers</button> aka getByRole('button', { name: 'Headers' })
    2) <div class="border-t border-glass px-3 py-1.5 text-[10px] font-semibold uppercase tracking-widest text-neutral-500">Headers</div> aka locator('div').filter({ hasText: /^Headers$/ })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Headers', { exact: true })
...
- generic [ref=e3]:
  ...
  - contentinfo [ref=e249]:
    - button "sidecar v0.0.1 · 54s · 0m" [ref=e251] [cursor=pointer]:
      - generic [ref=e255]: sidecar v0.0.1
      - generic [ref=e256]: · 54s
      - generic [ref=e257]: · 0m
