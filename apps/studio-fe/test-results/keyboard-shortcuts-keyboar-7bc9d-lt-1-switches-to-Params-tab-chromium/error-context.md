...
- Name: keyboard-shortcuts.spec.ts >> keyboard shortcuts >> Alt+1 switches to Params tab
- Location: tests/e2e/keyboard-shortcuts.spec.ts:66:3
...
Locator: getByText('Headers')
Expected: visible
Error: strict mode violation: getByText('Headers') resolved to 3 elements:
    1) <button type="button" class="relative h-8 rounded-lg px-3 text-[11px] font-medium transition-all duration-150 bg-white/[0.08] text-neutral-100 shadow-sm">Headers</button> aka getByRole('button', { name: 'Headers' })
    2) <p class="text-[11px] uppercase tracking-wider text-neutral-500">Headers</p> aka getByRole('paragraph').filter({ hasText: 'Headers' })
    3) <td colspan="4" class="px-3 py-3 text-center text-neutral-600">No headers</td> aka getByRole('cell', { name: 'No headers' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Headers')
  ...
  - main [ref=e138]:
    ...
    - generic [ref=e210]:
      - generic [ref=e212]:
        ...
        - generic [ref=e224]:
          - generic [ref=e225]:
            - paragraph [ref=e226]: Headers
            - generic [ref=e227]:
              - generic [ref=e228]:
                - button "Table" [ref=e229] [cursor=pointer]
                - button "Raw" [ref=e230] [cursor=pointer]
              - button "Quick Add" [ref=e232] [cursor=pointer]:
                - text: Quick Add
                - img [ref=e233]
          - table [ref=e236]:
            - rowgroup [ref=e237]:
              - row "Name Value" [ref=e238]:
                - columnheader [ref=e239]
                - columnheader "Name" [ref=e240]
                - columnheader "Value" [ref=e241]
                - columnheader [ref=e242]
            - rowgroup [ref=e243]:
              - row "No headers" [ref=e244]:
                - cell "No headers" [ref=e245]
          - button "+ Add header" [ref=e246] [cursor=pointer]
      - generic [ref=e251]:
        - img [ref=e253]
        - paragraph [ref=e256]: No response yet
        - paragraph [ref=e257]: Hit Send or press ⌘⏎
  - contentinfo [ref=e259]:
    - button "sidecar v0.0.1 · 4m · 0m" [ref=e261] [cursor=pointer]:
