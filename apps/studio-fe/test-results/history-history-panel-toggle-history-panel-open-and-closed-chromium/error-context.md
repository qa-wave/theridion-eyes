...
- Name: history.spec.ts >> history panel >> toggle history panel open and closed
- Location: tests/e2e/history.spec.ts:72:3
...
Locator: getByPlaceholder('Search URL, method...')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByPlaceholder('Search URL, method...')
