...
- Name: settings.spec.ts >> settings modal >> switching to AI tab shows provider selection
- Location: tests/e2e/settings.spec.ts:44:3
...
Expected: visible
Error: strict mode violation: getByText('Provider') resolved to 2 elements:
    1) <p class="mb-2 text-[11px] font-semibold uppercase tracking-widest text-neutral-500">Provider</p> aka getByText('Provider', { exact: true })
    2) <div class="rounded-md border border-glass bg-neutral-900/20 px-3 py-2 text-[11px] text-neutral-500">Ollama runs locally — your data never leaves your…</div> aka getByText('Ollama runs locally — your')
    ...
    - generic [ref=e286]:
      ...
      - generic [ref=e292]:
        - button "General" [ref=e293] [cursor=pointer]:
          - img [ref=e294]
          - text: General
        - button "AI" [active] [ref=e297] [cursor=pointer]:
          - img [ref=e298]
          - text: AI
        ...
        - button "Shortcuts" [ref=e311] [cursor=pointer]:
          - img [ref=e312]
          - text: Shortcuts
        - button "About" [ref=e314] [cursor=pointer]:
          - img [ref=e315]
          - text: About
    - generic [ref=e317]:
      - generic [ref=e318]:
      ...
      - generic [ref=e325]:
        - generic [ref=e326]:
          - paragraph [ref=e327]: Provider
          - combobox [ref=e328]:
            - option "Ollama (local, private)" [selected]
            - option "OpenAI"
            - option "Anthropic"
        - generic [ref=e329]:
          - paragraph [ref=e330]: Ollama Base URL
          - generic [ref=e331]:
            - textbox [ref=e332]: http://localhost:11434
            - button "Ping" [ref=e333] [cursor=pointer]
        - generic [ref=e334]:
          - paragraph [ref=e335]: Model
          - generic [ref=e336]:
            - combobox [ref=e337]:
              - option "llama3.2" [selected]
            - button "Refresh" [ref=e338] [cursor=pointer]
        - generic [ref=e339]: Ollama runs locally — your data never leaves your machine. Cloud providers send request/response data to external servers.
      - generic [ref=e340]:
